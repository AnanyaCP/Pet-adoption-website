...
<body>
    ...
    <div class="container">
        ...
        <p style="margin-top: 30px; color: #777;">
            ...
            <span style="color: var(--primary-color); font-weight: bold;">Luna</span>
        </p>

        <div class="pet-detail-wrapper">
            <!-- Left: Image -->
            <div class="pet-image-gallery">
                <img src="cat.webp" alt="Luna the Cat">
            </div>

            <!-- Right: Info -->
            <div class="pet-info">
                <h1>Luna</h1>
                <span class="pet-breed"> • 1 Year Old</span>
                ...
                <div class="pet-description">
                    <p>Luna is a vocal and affectionate cat who demands attention in the sweetest way possible. She loves to perch on high shelves and supervise household activities. She is incredibly intelligent and curious about everything you do.</p>
                    <p>She would thrive in a home where she gets plenty of play time and mental stimulation. Luna gets along with other calm cats but might be too energetic for older pets.</p>
                </div>

                <div style="display: flex; align-items: center;">
                    <!-- Auto-fills application with 'Luna' -->
                    <a href="adopt.php?pet=Luna" class="button">Adopt Luna</a>
