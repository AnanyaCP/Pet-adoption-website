...
<body>
    ...
    <div class="container">
        ...
        <p style="margin-top: 30px; color: #777;">
            ...
            <span style="color: var(--primary-color); font-weight: bold;">Daisy</span>
        </p>

        <div class="pet-detail-wrapper">
            <!-- Left: Image -->
            <div class="pet-image-gallery">
                <img src="b.jpeg" alt="Daisy the Dog">
            </div>

            <!-- Right: Info -->
            <div class="pet-info">
                <h1>Daisy</h1>
                <span class="pet-breed">Beagle • 2 Years Old</span>
                ...
                <div class="pet-description">
                    <p>Daisy is a sweet-natured Beagle with a nose for adventure! True to her breed, she is curious, vocal, and loves to follow a scent wherever it leads. She has the classic Beagle howl and a wagging tail that never stops.</p>
                    <p>She gets along famously with other dogs and loves children. Daisy would be happiest in a home with a secure yard where she can sniff and explore safely.</p>
                </div>

                <div style="display: flex; align-items: center;">
                    <!-- Auto-fills application with 'Daisy' -->
                    <a href="adopt.php?pet=Daisy" class="button">Adopt Daisy</a>
