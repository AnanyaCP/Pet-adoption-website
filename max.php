...
<body>
    ...
    <div class="container">
        ...
        <p style="margin-top: 30px; color: #777;">
            ...
            <span style="color: var(--primary-color); font-weight: bold;">Max</span>
        </p>

        <div class="pet-detail-wrapper">
            <!-- Left: Image -->
            <div class="pet-image-gallery">
                <img src="max.webp" alt="Max the Puppy">
            </div>

            <!-- Right: Info -->
            <div class="pet-info">
                <h1>Max</h1>
                <span class="pet-breed">Labrador Mix • 5 Months Old</span>
                ...
                <div class="pet-stats">
                    ...
                    <div class="stat-box">
                        ...
                        <span class="stat-value">Large (Growing)</span>
                    </div>
                    <div class="stat-box">
                        <span class="stat-label">Vaccinated</span>
                        <span class="stat-value" style="color: #f39c12;">In Progress </span>
                    </div>
                </div>

                <div class="pet-description">
                    <p>Max is a bundle of pure energy and puppy love! He is currently learning basic commands like 'sit' and 'stay' and is incredibly food motivated, which makes training fun. He loves to chew on his toys and chase after anything that moves.</p>
                    <p>He needs a patient family who can commit to ongoing training and dealing with typical puppy antics. Max would be an amazing companion for an active household.</p>
                </div>

                <div style="display: flex; align-items: center;">
                    <!-- Auto-fills application with 'Max' -->
                    <a href="adopt.php?pet=Max" class="button">Adopt Max</a>
