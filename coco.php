...
<body>
    ...
    <div class="container">
        ...
        <p style="margin-top: 30px; color: #777;">
            ...
            <span style="color: var(--primary-color); font-weight: bold;">Coco</span>
        </p>

        <div class="pet-detail-wrapper">
            <!-- Left: Image -->
            <div class="pet-image-gallery">
                <img src="co.jpg" alt="Coco the Cat">
            </div>

            <!-- Right: Info -->
            <div class="pet-info">
                <h1>Coco</h1>
                <span class="pet-breed">Persian • 6 Years Old</span>
                ...
                <div class="pet-description">
                    <p>Coco is the definition of feline royalty. This fluffy Persian beauty enjoys a quiet life filled with soft pillows and gentle brushing. She is very relaxed and low-energy, making her the perfect companion for a laid-back household.</p>
                    <p>She requires daily grooming to keep her magnificent coat in top shape. Coco prefers a calm environment without loud noises or active children, where she can reign supreme as the queen of the castle.</p>
                </div>

                <div style="display: flex; align-items: center;">
                    <!-- Auto-fills application with 'Coco' -->
                    <a href="adopt.php?pet=Coco" class="button">Adopt Coco</a>
